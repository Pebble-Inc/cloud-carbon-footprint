...
echo DOCUMENTDB_SSL_CA_FILE=$DOCUMENTDB_SSL_CA_FILE >> .env
echo DOCUMENTDB_USERNAME=$DOCUMENTDB_USERNAME >> .env
echo DOCUMENTDB_PASSWORD=$DOCUMENTDB_PASSWORD >> .env
echo TENANT_DB=$TENANT_DB >> .env
echo DOCUMENTDB_URI=$DOCUMENTDB_URI >> .env
echo CCF_AWS_TARGET_ACCOUNT_ROLE_NAME=$CCF_AWS_TARGET_ACCOUNT_ROLE_NAME >> .env
echo CCF_AWS_AUTH_MODE=$CCF_AWS_AUTH_MODE >> .env
echo CCF_CACHE_MODE=$CCF_CACHE_MODE >> .env
echo AWS_REGION=$AWS_REGION >> .env
echo ECS_ROLE_NAME=$ECS_ROLE_NAME >> .env
echo TENANT_ROLE_NAME=$TENANT_ROLE_NAME >> .env
